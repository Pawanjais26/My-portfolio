...
export default function CertificateCard() {
  return (
    <div className='container my-5 p-5' style={{ backgroundColor: "#E5D1FA" }}>
      ...
      <h1 class="display-4 fw-bold lh-1 mb-4 pb-4 text-center left-animation">
        ...
        <div className='col-12 col-lg-6 col-md-5 col-sm-12 mb-4 text-center text-lg-start heading2'>
